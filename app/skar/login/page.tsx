      ...
      >
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="px-2 bg-[var(--color-bg)] text-[var(--color-muted)]">or</span>
          </div>
        </div>

        <button
          onClick={() => signIn("google", { callbackUrl: "/skar" })}
          className="w-full py-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)]
                   hover:bg-[var(--color-border)] transition-colors font-medium text-sm flex items-center justify-center gap-2"
        >
